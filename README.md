...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/videohash-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15444&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/videohash-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `videohash` can be installed with:

```
conda install videohash
```

It is possible to list all of the versions of `videohash` available on your platform with:
